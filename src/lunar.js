...
// 数字转中文 ['日','一','二','三','四','五','六','七','八','九','十']
const nStr1 = ['\u65e5', '\u4e00', '\u4e8c', '\u4e09', '\u56db', '\u4e94', '\u516d', '\u4e03', '\u516b', '\u4e5d', '\u5341']

// 农历日期名称 ['初','十','廿','卅']
const nStr2 = ['\u521d', '\u5341', '\u5eff', '\u5345']

// 农历月份名称 ['正','一','二','三','四','五','六','七','八','九','十','冬','腊']
...
// 传入公历y年(1900-2100)获得该年第n个节气(1~24)的公历日期 从n=1(小寒)算起
...
// 传入阳历年月日获得详细的公历/农历信息 参数区间1900.1.31~2100.12.31
export default function solar2lunar (y, m, d) {
    // 年份限定、上限
    if (y < 1900 || y > 2100) {
        return -1
    }
